...
-- ----------------------------
BEGIN;
INSERT INTO `system_menu` (`id`, `created_at`, `update_at`, `parent_id`, `name`, `type`, `slug`, `icon`, `router`, `order_by`) VALUES (1, '2025-02-18 00:14:48', '2025-02-18 00:14:48', NULL, '首页', 'menu', '', 'i-icon-park-outline-home', '/admin', 1);
...
INSERT INTO `system_menu` (`id`, `created_at`, `update_at`, `parent_id`, `name`, `type`, `slug`, `icon`, `router`, `order_by`) VALUES (5, '2025-02-18 00:14:48', '2025-02-18 00:14:48', 2, '用户管理', 'menu', '', 'i-icon-park-outline-peoples', '/admin/permission/user', 1);
INSERT INTO `system_menu` (`id`, `created_at`, `update_at`, `parent_id`, `name`, `type`, `slug`, `icon`, `router`, `order_by`) VALUES (6, '2025-02-18 00:14:48', '2025-02-18 00:14:48', 2, '菜单管理', 'menu', '', 'i-icon-park-outline-mindmap-list', '/admin/permission/menu', 2);
INSERT INTO `system_menu` (`id`, `created_at`, `update_at`, `parent_id`, `name`, `type`, `slug`, `icon`, `router`, `order_by`) VALUES (7, '2025-02-18 00:14:48', '2025-02-18 00:14:48', 2, '角色管理', 'menu', '', 'i-icon-park-outline-permissions', '/admin/permission/role', 3);
INSERT INTO `system_menu` (`id`, `created_at`, `update_at`, `parent_id`, `name`, `type`, `slug`, `icon`, `router`, `order_by`) VALUES (8, '2025-02-18 00:14:48', '2025-02-18 00:14:48', 3, '字典管理', 'menu', '', 'i-icon-park-outline-notebook-one', '/admin/data/dict', 1);
INSERT INTO `system_menu` (`id`, `created_at`, `update_at`, `parent_id`, `name`, `type`, `slug`, `icon`, `router`, `order_by`) VALUES (9, '2025-02-18 00:14:48', '2025-02-18 00:14:48', 3, '文件管理', 'menu', '', 'i-icon-park-outline-file-cabinet', '/admin/data/file', 2);
INSERT INTO `system_menu` (`id`, `created_at`, `update_at`, `parent_id`, `name`, `type`, `slug`, `icon`, `router`, `order_by`) VALUES (10, '2025-02-18 00:14:48', '2025-02-18 00:14:48', 4, '日志管理', 'menu', '', 'i-icon-park-outline-log', '/admin/system/log', 1);
